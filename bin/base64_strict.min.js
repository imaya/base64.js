...
0<a&&(b+=2===a?"==":"=");return b}i.a="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");function k(e){for(var f=0,b=0,c=e.length,d="",a=0,g=k.b,h=k.c,n,j;"="===e.charAt(c-1);)--c;if(1===c%4||0<e.length&&0===c)throw Error("INVALID_CHARACTER_ERR");for(;b<c;){j=e.charCodeAt(b++);n=256>j?h[j]:-1;if(-1===n)throw Error("INVALID_CHARACTER_ERR");f=(f<<6)+n;a+=6;8<=a&&(a-=8,j=f>>a,d+=g[j],f^=j<<a)}return d}var l=k,m=Array(256),p;for(p=0;255>p;++p)m[p]=String.fromCharCode(p);
l.b=m;var q=k,r=i.a,s=new ("undefined"!==typeof Int16Array?Int16Array:Array)(256),t=k.b,u;for(u=0;255>u;++u)s[u]=r.indexOf(t[u]);q.c=s;this.Base64=this.Base64||{};this.Base64.atob=k;this.Base64.btoa=i;}).call(this);
